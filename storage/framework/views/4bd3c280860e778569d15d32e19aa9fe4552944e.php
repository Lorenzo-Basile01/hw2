...
<body>
    ...
    <h1 class="comp">Registrati!</h1>
        ...
        <form name='signup' method='post' id = 'form' action="<?php echo e(route('createUser')); ?>">
            <?php echo csrf_field(); ?>
            <!-- NAME -->
            <div class = "parent">
            <div class="name">
        ...
        <div class="signup">Hai già un account ? <a href="<?php echo e(asset('/login')); ?> ">Fai il login !</a></div>
    </div>
    </section>
...
</html><?php /**PATH C:\Users\Lorenzo\hw2\resources\views/signup.blade.php ENDPATH**/ ?>